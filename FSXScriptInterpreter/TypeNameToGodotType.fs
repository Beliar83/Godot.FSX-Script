...
//     //
//     //Some lines have changed to accomodate the fact that we don't have access to the GodotSharp .DLL
//     //
...
//                 | "GodotSharp.Godot.Vector2" -> Some (VariantType.INT, PropertyHint.None, "")
